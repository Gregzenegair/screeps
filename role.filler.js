        ...
        if (null != creep.memory.fillTarget) {
            ...
            if (null != memTarget && null != memTarget.store) {
                if (memTarget.structureType === STRUCTURE_CONTAINER
                    ...
                    target = _.sum(memTarget.store[RESOURCE_ENERGY]) < memTarget.store.getCapacity(RESOURCE_ENERGY) - memTarget.store[RESOURCE_ENERGY] ? memTarget : null;
                } else {
                    target = memTarget.energy < memTarget.energyCapacity - memTarget.energy ? memTarget : null;
                }
            }
        }
